...
function renderExpenses() {
    ...
    container.innerHTML = expenses.map(expense => {
        // Find the category using type-safe comparison
        const category = categories.find(c => String(c.id) === String(expense.category_id));

        // Fallback if no category found
        const categoryName = category ? escapeHtml(category.name) : 'Miscellaneous';
            ...
            <div class="col-md-6 col-lg-4">
                <div class="expense-card">
                    ...
                    <div class="expense-category">
                        <i class="bi bi-folder-fill me-2"></i>${categoryName}
                    </div>
